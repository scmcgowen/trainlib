...
--[[
This file is licensed under MPL-2.0 and not the default license of this project
It is a modification of the CC:Tweaked cc.expect library

This modification allows TrainLib's objects to be checked for by type
]]

--[[- The [`trainlib.internal.expect`] library provides helper functions for verifying that
function arguments are well-formed and of the correct type.

@module trainlib.internal.expect
...
local function expect(index, value, ...)
    local t = get_display_type(value,native_type(value))
